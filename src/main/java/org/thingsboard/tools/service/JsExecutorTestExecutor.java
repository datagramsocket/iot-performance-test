...
import org.thingsboard.tools.service.jsexecutor.JsExecutorTest;
...
public class JsExecutorTestExecutor {

    @Value("${test.enabled:true}")
    protected boolean testEnabled;

    @Autowired
    private JsExecutorTest jsExecutorTest;
